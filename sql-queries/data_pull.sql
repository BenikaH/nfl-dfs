...
LEFT JOIN espn_wkly_proj e on e.player_id = map.espn_id and e.week = 2
LEFT JOIN cbssports_wkly_proj c on c.player_id = map.cbssports_id and c.week = 2
LEFT JOIN team_map tm on nf.team = tm.nf_team
LEFT JOIN rotogrinders_odds rgo on rgo.team = tm.rg_team and rgo.week = 2
LEFT JOIN pinnacle_odds p on p.team = tm.pinnacle_team and p.week = 2
